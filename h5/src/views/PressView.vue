<template>
  <div class="ins">
    <img src="@/assets/press-ban.jpg" w-1>
    <dl c-38 fz-24 class="ins-cont" auto v-for="(item,index) in arr" :key="index">
      <dt>
        <h4 fz-28>{{item.tit}}</h4>
        <p fz-24>{{item.cont}}</p>
      </dt>
      <dd>
        <img :src="item.img">
...
<script>
import press1 from "@/assets/press-img2.jpg";
import press2 from "@/assets/press.jpg";
export default {
name: "PressView",
  data(){
    return{
