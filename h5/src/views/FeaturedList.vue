<template>
  <div class="ins">
    ...
    <div class="ins-cont" fz-24 c-38 auto>
      ...
      <p>
        Biden's first three weeks in the stock market have been a spectacular start. Since Election Day, the S&P 500 has surged 7.7%, which is the second-highest gain in 90 years.
      </p>
    </div>
  </div>
</template>
...
<style scoped>
.ins-cont{width: 640px;}
.ins-cont h4{padding: 60px 0 40px 0;}
.ins-cont p{line-height: 50px;padding-bottom: 50px;}
</style>